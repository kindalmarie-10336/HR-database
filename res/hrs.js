         function get_data(query_url, spc){
                   // Sample Queries:
                                   ...
                                   if (is_err == -1) {
                                     ...
                                     for (i = 0; i < responseJ.table.rows.length; i++) {
                                       ...
                                       if (val_a == "no value"){
                                           ...
                                           // Parse and reorder the date string that is returned from
                                       ...
                                       // This will force "County" specific results to be listed ahead of results whose "County"
                                       // designation is set to "-- All --".
                                          if (spc == "yes") {
                                             var this_case = "-- All --";
                                             var is_all = tmp_val.toLowerCase().indexOf(this_case.toLowerCase());
                                             if (is_all != -1) {
                                                all_list = all_list + tmp_val + '<tr><td colspan="2"><hr width="750px" /></td></tr>';
                                             }else{
                                       ...
                                       // Combine the finished Data Result List for a specific "County" with the list of Data Results
                                       // for "-- All --" counties. If there has not been a Special Use Case created by the search filters, 
                                       // this concatenation should not change the Final Results in any way. 
                                       value = value + all_list;
         ...
         function getText(){
                   ...
                   // Get the values of the Dropdowns Options Boxes.
                      ...
                      if (f_county == "-- Any --" || f_county == ""){
                         ...
                         sp_case = "yes";
                         const c_all = "-- All --";
                         filter_query = filter_query + "(LOWER(I) contains '" + f_county.toLowerCase() + "') or " + "(LOWER(I) contains '" + c_all.toLowerCase() + "') and ";
                      };                                
