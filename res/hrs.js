                             ...
                             .then(function(response) {
                                   ...
                                   if (is_err == -1) {
                                     ...
                                     for (i = 0; i < responseJ.table.rows.length; i++) {
                                       ...
                                       // "County" designation is set to "-- All --".
                                          if (val_i.toLowerCase() == cou_all.toLowerCase()) {
                                                all_list = all_list + tmp_val + '<tr><td colspan="2"><hr width="750px" /></td></tr>';
                                          }else{
                                                gen_list = gen_list + tmp_val + '<tr><td colspan="2"><hr width="750px" /></td></tr>';
                                          };
                                     };

                                     // Combine the finished Data Result Lists so that the "-- All --" designated counties 
                                     // come at the end of the Results. 
                                       value = gen_list + all_list;
